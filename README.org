...
This repository provides 19 pre-built container images across 5 distributions with
...
| Distro   | Images                                                    |
|----------+-----------------------------------------------------------|
| Arch     | cider, emacs, latex, emacs-ai, emacs-latex, emacs-latex-ai |
| Fedora   | cider, emacs, latex, emacs-ai, emacs-latex, emacs-latex-ai |
| Alpine   | emacs, latex, emacs-ai, emacs-latex-ai                     |
| Debian   | cider                                                      |
| OpenSUSE | emacs, emacs-ai                                            |

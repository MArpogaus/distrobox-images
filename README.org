...
| Distro   | Images                                                                                             | Count |
|----------+----------------------------------------------------------------------------------------------------+-------|
| Arch     | cider, dev, emacs, latex, emacs-ai, emacs-latex, emacs-latex-ai                                    | 7     |
| Fedora   | cider, dev, emacs, latex, emacs-ai, emacs-latex, emacs-latex-ai                                     | 7     |
...
- *dev* — Development tools (emacs + latex on Arch, emacs + latex on Fedora)
- *emacs* — Emacs editor
...
The [[file:.github/workflows/build-and-publish.yml][build-and-publish workflow]] defines a single matrix job that builds all 22 images.
